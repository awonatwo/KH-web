...
<style>
span#mainMenu {color:navy; font-size:2em;}
span#sideMenu {color:indigo; font-size:1.5em;}
span#drinkMenu {color:yellowgreen;}
...
<body>
	<h2>감사합니다.</h2>
		...
		<span id="drinkMenu"><%=drinkMenu %></span>을/를 주문하셨습니다. <br />
</body>
</html>